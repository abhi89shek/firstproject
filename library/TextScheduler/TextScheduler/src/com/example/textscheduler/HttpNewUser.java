...
public class HttpNewUser extends  AsyncTask<String[], Void, StringBuffer >{
	
	private Context context;
	private ProgressDialog dialog;
	
	public HttpNewUser(Context c)
	{
		super();
		context = c;
	}
    ...
    protected StringBuffer doInBackground(String[]... params) {
		...
		nameValuePairs.add(new BasicNameValuePair("userId", temp[2]));
		nameValuePairs.add(new BasicNameValuePair("password", temp[3]));
    	try {
