...
public class Httpuser extends  AsyncTask<String[], Void, StringBuffer >{
	
	private Context context;
	private ProgressDialog dialog;
	
	public Httpuser(Context c)
	{
		super();
		context = c;
	}
    ...
    protected StringBuffer doInBackground(String[]... params) {
		...
		nameValuePairs.add(new BasicNameValuePair("userId", temp[1]));
		nameValuePairs.add(new BasicNameValuePair("password", temp[2])); 
    	try {
